# Adapted from https://github.com/justchenhao/STANet/blob/master/models/mynet3.py
...
def build_backbone(backbone, output_stride, BatchNorm, pretrained=False, in_c=3):
    if backbone == 'resnet50':
        return ResNet50(output_stride, BatchNorm, pretrained=pretrained, in_c=in_c)
    elif backbone == 'resnet34':
        return ResNet34(output_stride, BatchNorm, pretrained=pretrained, in_c=in_c)
    elif backbone == 'resnet18':
        return ResNet18(output_stride, BatchNorm, pretrained=pretrained, in_c=in_c)
    else:
        raise NotImplementedError
